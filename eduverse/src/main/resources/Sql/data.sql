...
# Module
INSERT INTO  module (name, content, duration, course_id) values ("Chapter 1", "Intro to varibale","12min", "1");
...
INSERT INTO announcement (title, content, noti_type, admin_id, course_id)VALUES ("Exam Schedule Reminder", "Don't forget, the midterm exams are scheduled for next week. Be prepared!", "Admin", "1", "1");
