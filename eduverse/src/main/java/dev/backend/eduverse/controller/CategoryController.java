...
@Tag(
        ...
        description = "CRUD REST APIs - Create Category, Update Category, Get Category By Id, Get All Category, Delete Category, Update Category"
)
@RestController
...
public class CategoryController {
    ...
    public ResponseEntity<ApiResponse<String>> createCategory(@Valid @RequestBody CategoryDto categoryDto) {
        try {
            ...
            return ResponseUtil.createSuccessResponse(HttpStatus.OK, "Category Created successfully", categoryDto.toString());
        } catch (DataIntegrityViolationException e) {
            return ResponseUtil.createErrorResponse(HttpStatus.BAD_REQUEST, "Failed to create category", e.getMessage());
        } catch (Exception e) {
            return ResponseUtil.createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Failed to create category", e.getMessage());
        }
    }
    ...
    @Operation(summary = "Update  category", tags = {"Update Category"})
    public ResponseEntity<ApiResponse<CategoryDto>> UpdateCategory(@Valid @RequestBody CategoryDto categoryDto , @PathVariable Long categoryId){
        try{
            ...
            return ResponseUtil.createSuccessResponse(HttpStatus.OK , "Updated successfully",updatedCategory);
        }catch (Exception e){
            return ResponseUtil.createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Failed to Update category", null);
        }
    }
    ...
    public ResponseEntity<ApiResponse<String>> deleteCategory(@PathVariable Long categoryId){
        try{
            ...
            return ResponseUtil.createSuccessResponse(HttpStatus.OK , "Category Deleted successfully","Id " + categoryId);
        }catch (EmptyResultDataAccessException e) {
            return ResponseUtil.createErrorResponse(HttpStatus.NOT_FOUND, "Category not found", null);
        }catch (Exception e) {
            return ResponseUtil.createErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Failed to delete Category", e.getMessage());
        }
    }
}
