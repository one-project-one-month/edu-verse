...
public class userCourseController {
    ...
    @Autowired
    private userCourseServices userCourseService;
    ...
    @PutMapping("/{id}")
    public ResponseEntity<userCourseDTO> updateUserCourse(@PathVariable long id, @RequestBody userCourseDTO userCourseDTO) {
