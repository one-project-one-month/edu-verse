...
@Tag(
        ...
        description = "CRUD REST APIs - Create Announcement, Update Announcement, Get Announcement By Id, Get All Announcements, Delete Announcement"
)
@RestController
@AllArgsConstructor
...
public class AnnouncementController {
    ...
    @Operation(
            ...
            description = "Get All Announcement REST API is used to get all the Announcements from the database"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Announcement By Id REST API is used to get a single Announcement from the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "HTTP Status 200 SUCCESS"
    ...
    @Operation(
            ...
            description = "Update Announcement REST API is used to update a particular Announcement in the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "HTTP Status 200 SUCCESS"
    ...
    @PutMapping("{id}")
    public ResponseEntity<AnnouncementDto> updateAnnouncement(@PathVariable("id") Long id, @RequestBody @Valid AnnouncementDto announcement){
    ...
    @Operation(
            ...
            description = "Delete Announcement REST API is used to delete a particular Announcement from the database"
    )
    @ApiResponse(
            responseCode = "200",
            description = "HTTP Status 200 SUCCESS"
