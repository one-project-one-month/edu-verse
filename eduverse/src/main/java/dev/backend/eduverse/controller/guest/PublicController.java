...
public class PublicController {
	...
	public PublicController(CourseService courseService, CategoryServiceImpl categoryService,
			PathwayService pathwayService, AnnouncementService announcementService) {
		super();
